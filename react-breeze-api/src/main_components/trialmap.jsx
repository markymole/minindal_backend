  ...
  return (
    <div>
      <section class="text-gray-600 body-font">
            <div class="absolute inset-0 bg-gray-300 z-10">
            ...
            <div class="container px-5 py-24 mx-auto flex">
                <div class="lg:w-1/3 md:w-1/2 bg-white rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative z-0 shadow-md">
