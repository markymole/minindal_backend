...
export function LoginPage(){
    ...
    const { login, errors, loginerror, setLoginError, setErrors, getUser, user, spinner } = useAuthContext();
    ...
    <div>
        ...
        <div className="p-10 xs:p-0 mx-auto md:w-full md:max-w-lg">
            ...
            <div className="px-5 py-7">
                ...
                <input type="email" placeholder='your@email.com' value={email} onChange={(e) => setEmail(e.target.value)} className="focus:outline-none border rounded-lg px-3 py-2 mt-1 mb-5 text-sm w-full" />
                {errors.email && (<div className='flex'><span className="text-red-400 text-sm m-2 p-2 -mt-3">{errors.email[0]}</span></div>)}
                <label className="font-semibold text-sm text-gray-600 pb-1 block">Password</label>
                
                {/* <input type="password" value={password} placeholder='password' onChange={(e) => setPassword(e.target.value)} className="border rounded-lg px-3 py-2 mt-1 mb-5 text-sm w-full"  /> */}
