...
{      
  ...
  return (
    <div className='pb-28'>
          <TopHeading linkTo={'/dashboard/records'} title={'Records'} subtitle={'Create'} id={''}/>
    
        <form className="w-4/5 mx-auto mt-12 h-fit" onSubmit={storeRecord} onKeyDown={(e) => checkKeyDown(e)} encType="multipart/form-data">
            <h5 className='text-2xl font-semibold'>Create Record</h5>
            ...
            <div className="create mt-6 overflow-hidden shadow ring-1 ring-black ring-opacity-5 md:rounded-lg p-6 bg-white space-y-6">
              ...
              <div className='w-full h-[50vh] pb-4 space-y-2'>
                    <SearchMap></SearchMap>
                    <p className='font-medium text-sm'>(Click anywhere on the map to drop the pin to set the coordinates of the location of the business.)</p>
              </div>
              <div>
