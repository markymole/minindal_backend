...
import { ReviewPost } from '../../components/ReviewPosts'
...
const Reviews = () => {
    ...
    useEffect(()=>{
     ...
     const filterItems = (filterValue) => {;
        ...
        if (filterValue !== '') {
            const filteredData = reviews.filter((reviews) => {
                return Object.values(reviews).join('').toLowerCase().includes(filterValue.toLowerCase())
                })
    ...
    const currentFilteredPosts = reviews.slice(indexOfFirstPost, indexOfLastPost);
  ...
  return (
    <div className='min-h-screen max-h-full'>
        <TopHeading linkTo={'/dashboard/reviews'} title={'Reviews'} subtitle={'List'} id={''}/>
        ...
        <div className="w-4/5 mx-auto mt-12 h-fit">
            <div className='flex justify-between'>
                <h5 className='text-2xl font-semibold'>Business Reviews</h5>
                ...
                <div className="flex space-x-4">
                        ...
                        <div hidden className="md:block  z-9">
                            <div className="relative flex items-center text-gray-400  z-9 focus-within:text-green-500">
                                ...
                                <input type="search" name="leadingIcon" id="leadingIcon" placeholder="Search here" className="w-full pl-14 pr-4 py-2.5 rounded-md text-sm text-gray-600 outline-none border border-gray-300 focus:border-2 focus:border-green-500 transition"></input>
                            </div>
                        </div>
          ...
          <div className="inline-block min-w-full py-2 align-middle mt-2">
                <Pagination postsPerPage={postsPerPage} totalPosts={reviews.length} paginate={paginate} currentP={currentPage} loading={loading} indexOfFirstPost={indexOfFirstPost} indexOfLastPost={indexOfLastPost}/>
                <ReviewPost reviews={currentPosts} loading={loading}/>
          </div>   
      </div>
