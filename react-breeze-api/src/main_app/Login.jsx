...
const Login = () => {
    ...
    const { errors, loginerror, guestLogin, spinner, setSpinner } = useAuthContext();
    ...
    <div className="min-h-screen fixed z-40 w-full flex flex-col justify-center sm:py-12 bg-zinc-900 bg-opacity-50 inset-0">
        <div className="p-2 md:p-10 xs:p-0 mx-auto w-full md:w-3xl md:w-fit">
            ...
            {/* <div className='flex flex-col items-center'>
                <img src={Logo} alt="Center for Kapampangan Studies" className='mx-auto w-40 mb-3' />
                <h1 className="font-bold text-center text-2xl mb-5">Center for <br /> Kapampangan Studies</h1>  
            </div> */}
            <div className="px-5 py-7">
                <div className='flex items-center justify-between mb-5'>
                    <h2 className='font-bold text-start text-lg'>User Login</h2>
                    <button className='' onClick={closeLoginModal}>
                ...
                <input type="email" placeholder='user@example.com' value={email} onChange={(e) => setEmail(e.target.value)} className="border rounded-lg px-3 py-2 mt-1 mb-5 text-sm w-full" />
