...
class UsersController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return response()->json(['message' => 'New user created successfully', 'user' => $user], 200);
    }
    ...
    public function login(Request $request)
    {
        ...
        if (Auth::attempt($credentials)) {
            ...
            if ($user->isUser()) {
                ...
                Auth::logout();
                return response()->json(['message' => 'The account has admin privileges, please login to the admin page.', 'role' => 'Admin'], 403);
            }
        }
